...
export function Waves({
    className = "",
    strokeColor = "rgba(52, 211, 153, 1)",  // Solid bright emerald
    ...
    // Initialization — helpers live inside the effect so the animation loop
    // never captures stale bindings (refs are the only shared mutable state).
    useEffect(() => {
        ...
        const setLines = () => {
            ...
            // Reduce gap to dramatically increase number of lines
            const xGap = 24
            const yGap = 24
            ...
            for (let i = 0; i < totalLines; i++) {
                ...
                path.setAttribute('stroke-width', '3') // Thicker lines for visibility
