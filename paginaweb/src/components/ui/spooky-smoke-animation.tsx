...
// --- RENDERER CLASS ---
interface SmokeProgramLocations {
  resolution: WebGLUniformLocation | null;
  time: WebGLUniformLocation | null;
  u_color: WebGLUniformLocation | null;
}

type SmokeProgram = WebGLProgram & SmokeProgramLocations;
...
void main(){gl_Position=position;}`;
  ...
  private setup(fragmentSource: string) {
    ...
    this.program = program as SmokeProgram;
...
export const SmokeBackground: React.FC<SmokeBackgroundProps> = ({ 
  smokeColor = "#10b981", // Default to emerald green
  className = ""
}) => {
    ...
    return (
      <div className={`absolute inset-0 z-0 pointer-events-none ${className}`}>
        ...
        {/* Overlay gradient to fade the smoke into the black background */}
